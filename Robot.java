...
public class Robot extends TimedRobot {
  ...
  public void autonomousPeriodic(){
    ...
    switch(autoStage){
      ...
      case 2 : {
        drive.driveTrainByInches(33.0, 1);
  ...
  public void teleopPeriodic() {
    ...
    // System.out.println("compass: " + gyro.getCompassHeading());
    // System.out.println("version: " + gyro.getFirmwareVersion());
    ...
    // System.out.println(gyro.getWorldLinearAccelX());
    // System.out.println(gyro.getWorldLinearAccelY());
    // System.out.println(gyro.getWorldLinearAccelZ());
    System.out.println(gyro.getYaw());
    // System.out.println(gyro.getPitch());
    // System.out.println(gyro.getVelocityX());
    // System.out.println(gyro.getVelocityY());
    // System.out.println(gyro.getVelocityZ());
    // System.out.println(gyro.getQuaternionW());
    // System.out.println(gyro.getQuaternionX());
    // System.out.println(gyro.getQuaternionY());
    // System.out.println(gyro.getQuaternionZ());
    // System.out.println(gyro.getRawMagX());
    // System.out.println(gyro.getRawMagY());
    // System.out.println(gyro.getRawMagZ());
    // System.out.println(gyro.getGyroFullScaleRangeDPS());
