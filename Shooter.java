...
public class Shooter {
    ...
    public void shoot() {
        ...
        if (shooting && !dumpShot) {
            ...
            if (Math.abs(calculatedAngle - tempAngle) > 0.004) {
                ...
                if(getXDistanceFromCenterOfHub(NetworkTableInstance.getDefault().getTable("limelight").getEntry("ty").getDouble(0.0)) > 200.0){
                    shootingCoefficient = 2.825f;
                } else {
                    shootingCoefficient = 2.765f;
                }
                double thresholdVelocity = (((((((calculatedVelocity * shootingCoefficient * 11.666 - 500.0) * 1.0728) * 1.00175) / 1.008) / 1.028) * 1.015) / 1.007);
                System.out.println("calculated: " + thresholdVelocity);
                System.out.println("real:" + masterShooterMotor.getSelectedSensorVelocity(1));
                System.out.println("distance: " + getXDistanceFromCenterOfHub(NetworkTableInstance.getDefault().getTable("limelight").getEntry("ty").getDouble(0.0)));
    ...
    public void dumpShot() { // 92 inches according to distance method
        ...
        if (dumpShot && !shooting) {
            ...
            double thresholdVelocity = (((dumpShotSpeed * 22068.97) * 1.0045) / 1.007);
            System.out.println("calculated: " + thresholdVelocity);
            System.out.println("real:" + masterShooterMotor.getSelectedSensorVelocity(1));
